    ...
    results: [
        {
            ...
            identity: {
                ...
                provider: 4,
                url:
                    "https://app.atmo.dev:8000/api/v2/identities/0ed4a4f1-7657-4c61-8bd5-a420fddc569b.json",
                uuid: "0ed4a4f1-7657-4c61-8bd5-a420fddc569b"
            },
            image: {
                description:
                    "Image with pre-installed iRODS 4.1 and 'isetup' script for easy generation of iRODS client environment for Wrangler at IU or TACC.\n\nCentOS 6.7\n\nSee the instructions for use here:\nhttps://iujetstream.atlassian.net/wiki/display/JWT/Using+Jetstream+to+access+Wrangler+data+collections+with+iRODS",
                end_date: null,
                icon: null,
                id: 69,
                ...
                url:
                    "https://app.atmo.dev:8000/api/v2/images/63446ced-33ab-538d-a586-b4fda157f6bc.json",
                user: 74,
            ...
            provider: {
                ...
                url:
                    "https://app.atmo.dev:8000/api/v2/providers/f906a5ee-34a8-499a-9185-a35feb3d6f01.json",
            ...
            size: {
                ...
                url:
                    "https://app.atmo.dev:8000/api/v2/sizes/d3aab647-d81a-4842-9cdc-3a9fcbb5c588.json",
                uuid: "d3aab647-d81a-4842-9cdc-3a9fcbb5c588"
            },
            start_date: "2016-05-02T19:42:39Z",
            status: "active",
            url:
                "https://app.atmo.dev:8000/api/v2/instances/bef907ca-2756-4bde-9736-3f1bcc8b58a6.json",
            usage: 14110.74,
            user: {
                id: 1,
                url:
                    "https://app.atmo.dev:8000/api/v2/users/01a3cde8-3759-41f8-8b4a-304f31f260d1.json",
                username: "sgregory",
            ...
            version: {
                ...
                name: "1.0",
                url:
                    "https://app.atmo.dev:8000/api/v2/image_versions/32e8d765-081d-4493-ab16-5d5f1867cea9.json"
            },
            vnc: true
        },
        {
            ...
            image: {
                ...
                url:
                    "https://app.atmo.dev:8000/api/v2/images/ead21e76-20e0-5ebd-8df6-e1262a6c1b56.json",
                user: 14,
            ...
            size: {
                ...
                url:
                    "https://app.atmo.dev:8000/api/v2/sizes/faf7efd9-1ed2-425e-9697-509742581c87.json",
                uuid: "faf7efd9-1ed2-425e-9697-509742581c87"
            },
            start_date: "2016-05-25T03:30:24Z",
            status: "active",
            url:
                "https://app.atmo.dev:8000/api/v2/instances/181d019d-8ca2-4bf6-9e93-0f3d213b5084.json",
            usage: 1815.99,
            user: {
                id: 1,
                url:
            ...
            version: {
                ...
                name: "1.0-base",
                url:
                    "https://app.atmo.dev:8000/api/v2/image_versions/2528e68b-1051-469a-99d6-a24fac1ace8b.json"
            },
            vnc: true
        }
    ]
