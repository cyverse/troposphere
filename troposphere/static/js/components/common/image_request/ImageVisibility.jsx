...
export default React.createClass({
    ...
    renderMembershipList: function() {
        if (this.props.value != "public") {
            if (this.props.all_users == null) {
                ...
                return (<MembershipList membership_list={this.props.membership_list} />);
    ...
    render: function() {
        ...
        <div className="form-group">
            <label htmlFor="vis" className="control-label">
                Image Visibility
            </label>
            <div className="help-block">
                A VM image can be made visible to you, a select group of users or to everyone. If you want visibility restricted to a select group of users, provide us a list of
                iPlant usernames. Public visibility means that any user will be able to launch the instance.
            </div>
