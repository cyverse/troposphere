...
export default React.createClass({
    ...
    propTypes: {
        ...
        existing_items: React.PropTypes.instanceOf(Backbone.Collection)
            .isRequired,
    ...
    renderRow: function(item) {
        return (
            <li className="many-to-many-list-item-choice" key={item.cid}>
                <span>{item}</span>
                <a
                    className="many-to-many-list-item-choice-close"
                    onClick={this.onRemoveObject}
                />
            </li>
        );
    },
    ...
    renderForm: function() {
        return (
            <form onsubmit={this.onFormSubmit}>{this.props.renderForm()}</form>
        );
    },
    render: function() {
        return (
            <div className="many-to-many-list-main">
                ...
                <div className="help-block" id="list_help">
                    To remove an item from the list, click the (-) on the RHS of
                    the item. To add a new item to the list, Click the (+) and
