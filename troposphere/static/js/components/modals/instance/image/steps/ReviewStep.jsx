...
export default React.createClass({
    ...
    renderAccessList: function(imageData) {
        if (imageData.visibility === "public") {
            return (
                <div className="form-group">
                    <label className="control-label col-sm-3">AccessList</label>
        ...
        var patterns = imageData.activeAccessList.map(function(pattern_match) {
            return (
                pattern_match.get("pattern") +
                "(" +
                pattern_match.get("type") +
                ")"
            );
        });
    ...
    renderTags: function(imageData) {
        ...
        return (
            <div className="form-group">
                <label className="control-label col-sm-3">Tags</label>
                <div className="help-block col-sm-9">{tags.join(", ")}</div>
            </div>
        );
    },
    ...
    renderFilesToExclude: function(imageData) {
        ...
        return (
            <div className="form-group">
                ...
                <div className="help-block col-sm-9">{files}</div>
            </div>
        );
    },
    ...
    renderBootScripts: function(imageData) {
        ...
        return (
            <div className="form-group">
                ...
                <div className="help-block col-sm-9">{scripts_list}</div>
            </div>
        );
    },
    ...
    renderLicenses: function(imageData) {
        ...
        return (
            <div className="form-group">
                <label className="control-label col-sm-3">Licenses</label>
                <div className="help-block col-sm-9">{licenses_list}</div>
            </div>
        );
    },
    ...
    renderBody: function(imageData) {
        var visibilityMap = {
            ...
            select:
                "Select Users (only you and selected users can see the image)"
        };
                ...
                <div className="form-group">
                    <div className="checkbox">
                        <label className="checkbox">
                            ...
                            />{" "}
                            I certify that this image does not contain
                            license-restricted software that is prohibited from
                            being distributed within a virtual or cloud
                            environment.
                        </label>
                    </div>
                </div>
    ...
    render: function() {
        ...
        return (
            <div>
                <div className="modal-body">{this.renderBody(imageData)}</div>
