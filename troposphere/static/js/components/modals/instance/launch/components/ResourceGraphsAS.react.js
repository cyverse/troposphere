...
export default React.createClass({
    ...
    render: function() {
        ...
        if ( identityProvider && size && resourcesUsed) {
            ...
            // AU's Used
            allocationConsumed = this.props.allocationSource.used;
            allocationTotal = this.props.allocationSource.quota;
            ...
            // Labels for bar graphs
            auLabel =  `${allocationPercent}% of ${allocationTotal} AS's from this Allocation Source`;
