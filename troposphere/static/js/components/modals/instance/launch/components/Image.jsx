...
export default React.createClass({
    ...
    renderTags: function() {
        ...
        return <Tags activeTags={activeTags} renderLinks={false} />;
    },

    render: function() {
        let image = this.props.image;
        let type = stores.ProfileStore.get().get("icon_set");
        let imageCreationDate = moment(image.get("start_date")).format(
            "MMM D, YYYY hh:mm a"
        );
        let iconSize = 67;
        let icon;
                    ...
                    <div className="media__content">
                        <div className="row">
                            <div className="col-md-3 t-wordBreaker">
                                ...
                                <time>{imageCreationDate}</time> by{" "}
                                <strong>
                            ...
                            <div className="col-md-4">{this.renderTags()}</div>
                        </div>
                    </div>
                </div>
                {alertMessage()}
