    ...
    render: function() {
        ...
        if (!this.state.active) {
            ...
            if (this.state.showAlert) {
                alertMessage = () => {
                    return (
                    <div style={{ position: "absolute", display: "inline-block", width: "250px", top: "25%", right: "0", left: "0", margin: "auto", padding: "5px 10px", background: "#F15757", boxShadow: "0 1px 2px rgba(0,0,0,.4)", color: "white", textAlign: "center", cursor: "no-drop !important" }}>
        ...
        return (
        <li style={{ position: "relative" }} className="media card" onClick={this.handleClick}>
                ...
                <div className="media__content">
                    <div className="row">
                        <div className="col-md-3 t-wordBreaker">
                            ...
                            <time>
                                {imageCreationDate}
                            </time> by <strong>{image.get("created_by").username}</strong>
                        </div>
