...
export default React.createClass({
    ...
    renderNoSizesAvailable: function(minRequirements) {
        ...
        <div className="col-sm-9 control-label pull -left">
            ...
            {this.props.version.get("min_cpu")} CPU
            {this.props.version.get("min_mem") / 1024} GB RAM
        </div>
        );
        return (
        <div>
    ...
    render: function() {
        ...
        if (this.props.version.get("min_cpu") && this.props.version.get("min_mem") && !this.state.size) {
            minRequirements = (
                <div className="col-sm-9 control-label pull-right">
                    Minimum requirements:
                    {this.props.version.get("min_cpu")} CPU
                    {this.props.version.get("min_mem") / 1024} GB RAM
                </div>
                ...
                <div className="modal-section form-horizontal">
                    ...
                    <div className="form-group">
                        ...
                        <div className="col-sm-9">
                            <InstanceSizeSelect min_cpu={this.props.version.get("min_cpu")}
