...
export default React.createClass({
    ...
    render: function() {
        ...
        <div>
            ...
            <span className="badge-modal-text"><strong>Criteria:</strong>{criteria} <p> <strong>What does this mean{'?'}</strong> </p> <p> Text here about how to earn this badge in detail </p></span>
        </div>
        );
