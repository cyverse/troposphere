            ...
            <div role="form">
                <div>
                    <div
                        ...
                        There are two types of resource requests that can be
                        made:
                    </div>
                    <ol>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <p>
                                        Quota controls the amount of resources
                                        (CPU, RAM, etc) that can be used at a
                                        given time. The end result would be that
                                        you can launch more instances, or larger
                                        instances.
                                    </p>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <p>
                                        Allocation controls the use of
                                        resources, over time. This means that
                                        you can use instances, for example, for
                                        a longer period of time.
                                    </p>
                                    <p
                                        className="alert alert-warning"
                                        role="alert">
                                        <strong>NOTE:</strong> Jetstream Trial
                                        Allocations (JTA) are for exploratory
                                        purposes only and currently the limits
                                        are hard-wired into the allocation. As
                                        such requests for JTA alterations cannot
                                        be supported.
                                    </p>
                                </li>
                            </ul>
                ...
                <div key="resource-question-radio-grp" className="form-group">
                    <div
                        style={{
                            fontSize: "18px",
                            fontWeight: 500,
                    ...
                    <div
                        key="check-allocation"
                        className="form-check"
                        style={divStyle}>
                        <label className="form-check-label">
                            <input
                                key="check-allocation-input"
        ...
        return (
            <div>
                ...
                <div style={{marginBottom: "10px"}}>
                    Requesting a supplemental allocation must be done through
                    the{" "}
                    <a href="https://portal.xsede.org/">
                ...
                <div>
                    ...
                    <ul style={{padding: "5px"}}>
                        <li>
                            <a
                                href="https://portal.xsede.org/knowledge-base/-/kb/document/axwu"
                                target="_blank">
                                How do I request supplemental service units for
                                an XSEDE allocation?
                            </a>
                        </li>
                    </ul>
