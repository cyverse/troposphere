...
export default React.createClass({
    ...
    renderCreateForm: function(createButtonText) {
        if (this.state.showCreateForm == false) {
            return (<div className="new-license-form new-item-form" style={{ "visibility": "hidden" }} />);
        } else {
            return (<CreateLicenseView onCreateLicense={this.onCreateLicense} licenseTitle={this.state.licenseTitle} />);
        }
    },
    ...
    renderModel: function(license) {
        return (
        <ChosenDropdownItem key={license.id}
            item={license}
    ...
    renderSelectedModel: function(license) {
        return (
        <ChosenSelectedItem key={license.id}
            item={license}
            propertyName={this.props.propertyName}
