...
export default React.createClass({
    ...
    renderCreateForm: function(createButtonText) {
        if (this.state.showCreateForm == false) {
            return (
                <div
                    className="new-license-form new-item-form"
    ...
    getNoResultsPhrase: function(query) {
        return (
            'No licenses found matching "' +
            query +
            '". Press enter to create a new license.'
        );
    },
        ...
        return (
            <div className="license-multi-select-and-create">
                ...
                <div className="help-block">
                    All licensed software should be documented here. Any user
                    who wishes to use an image with license restrictions will be
                    required to view and agree to the license prior to
                    launching.
                </div>
