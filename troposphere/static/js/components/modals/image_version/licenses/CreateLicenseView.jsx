...
export default React.createClass({
        ...
        if (this.state.licenseType == "URL") {
            ...
            <div className="form-group">
                ...
                <input type="text"
                    ...
                    value={this.state.licenseURL}
                    onChange={this.onLicenseURLChange} />
            </div>
            );
        } else {
            //"Raw Text"
    ...
    renderLicenseInputRadio: function() {
            ...
            urlRadio = (
                <label className="radio-inline">
                    <input checked="checked"
                        ...
                        id="licenseTypeURL"
                        value="URL"
                        onChange={this.onLicenseInputTypeChange} /> URL
                </label>);
            fullTextRadio = (
                <label className="radio-inline">
                    <input type="radio"
        ...
        return (
        <div>
            <label htmlFor="licenseTypeSelect">
                Input Type
            </label>
            <div className="form-group">
                {urlRadio}
