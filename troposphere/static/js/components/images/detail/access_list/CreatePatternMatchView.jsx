...
export default React.createClass({
    ...
    renderPatternMatch: function() {
        let placeholder =
            "wildcard*@cyverse.org (matches wildcard1@cyverse.org, wildcard_bob@cyverse.org";
        if (this.state.matchType == username) {
            placeholder = "wildcard* (matches wildcard1, wildcard_bob, ...)";
        }
        return (
            <div className="form-group">
                <label htmlFor="patternExpresion">Pattern</label>
                <input
                    type="text"
        ...
        return (
            <div className="new-license-form new-item-form CreatePatternView">
                <div className="license-input-type-container">
                    ...
                    <label htmlFor="patternOptions">Type</label>
                    {this.renderPatternOptions()}
                    <label htmlFor="accessOptions">Allow/Deny Access</label>
                    {this.renderAccessOptions()}
                </div>
                <div
                    className="new-item-form-header form-group clearfix"
