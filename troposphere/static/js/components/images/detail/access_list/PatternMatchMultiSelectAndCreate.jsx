...
export default React.createClass({
    ...
    renderCreateForm: function(createButtonText) {
        if (this.state.showCreateForm == false) {
            return (
                <div
                    className="new-pattern_match-form new-item-form"
                    style={{visibility: "hidden"}}
                />
            );
        } else {
            return (
                <CreatePatternMatchView
                    onCreatePatternMatch={this.onCreatePatternMatch}
    ...
    getNoResultsPhrase: function(query) {
        return (
            'No patterns found matching "' +
            query +
            '". Press enter to create a new pattern_match.'
        );
    },
        ...
        return (
            <div className="pattern_match-multi-select-and-create">
                ...
                <div className="help-block">
                    To grant access to future usernames and emails, you can add
                    patterns to the image. Any user who matches the
                    pattern_matches below will be granted access to launch
                    instances. This will affect previous and future versions of
                    the image. To see a list of all users who have access to a
                    specific version: Select 'Edit Version' below and refer to
                    'Version Shared With'
                </div>
