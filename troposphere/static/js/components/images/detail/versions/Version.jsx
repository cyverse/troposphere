...
export default React.createClass({
    ...
    renderAvailability() {
        ...
        return <AvailabilityView isSummary={!isOpen} version={version} />;
    },
    ...
    renderEditLink() {
        ...
        if (
            username === version.get("user").username ||
    ...
    renderDocObjectId() {
        ...
        if (hasDOI) {
            doiLink = <a href={`https://doi.org/${doi}`}>{`${doi}`}</a>;
        }
        return (
    ...
    renderSummary() {
        ...
        if (context.hasLoggedInUser()) {
            providerAvailability = (
                <AvailabilityView isSummary={!isOpen} version={version} />
            );
        }
        ...
        return (
            <div style={styles.content}>
                ...
                <div style={styles.availability}>{providerAvailability}</div>
            </div>
        );
    },
    ...
    render() {
        ...
        return (
            <MediaCard
                ...
                avatar={<Gravatar hash={versionHash} size={40} type={type} />}
    ...
    styles() {
        ...
        // content
        let contentDisplay = isOpen ? "block" : "flex";
