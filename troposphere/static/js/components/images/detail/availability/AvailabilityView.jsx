...
export default React.createClass({
    ...
    renderEndDated() {
        return (
            <div>
                <h4 className="t-body-2" style={{marginBottom: "5px"}}>
                    Not Available
                </h4>
            </div>
        );
    ...
    renderProviders() {
        ...
        let machines = stores.ProviderMachineStore.getMachinesForVersion(
            version
        );
        ...
        let providers;
        if (machines) {
            providers = machines.map(this.renderProviderMachine);
        }
