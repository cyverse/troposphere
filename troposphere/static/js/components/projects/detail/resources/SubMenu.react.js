        ...
        <div className="sub-menu">
            <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                    <li>
                        <a href="#" onClick={this.onCreateInstance}><i className={'glyphicon glyphicon-tasks'} /> Instance</a>
                    </li>
                    <li>
                        <a href="#" onClick={this.onCreateVolume}><i className={'glyphicon glyphicon-hdd'} /> Volume</a>
                    </li>
                    <li>
                        <a href="#" onClick={this.onCreateExternalLink}><i className={'glyphicon glyphicon-globe'} /> Link</a>
                    </li>
                </ul>
            </div>
        </div>
