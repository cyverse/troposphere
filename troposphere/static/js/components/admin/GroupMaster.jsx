...
export default React.createClass({
    ...
    renderTable: function() {
        ...
        let rows = groups.map(group => <Group key={group.id} group={group} />);

        if (rows.length == 0) {
            return (
                <div>
                    <h3 className="t-title">
                        No groups were returned from the API
                    </h3>
                </div>
            );
        }
                ...
                <tbody>
                    <tr className="admin-row">
                        <th style={{border: "none"}}>
                            <h4 style={{margin: "0"}} className="t-body-2">
                                group
                            </h4>
                        </th>
                        <th style={{border: "none"}}>
                            <h4 style={{margin: "0"}} className="t-body-4">
                                Users
                            </h4>
                        </th>
                        <th style={{border: "none"}}>
