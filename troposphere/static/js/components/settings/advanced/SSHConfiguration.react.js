  ...
  function (React, ModalHelpers, SSHKeyUpload,  actions, modals, stores) {
    ...
    return React.createClass({
      ...
      handleChangeSSHPreference: function (event) {
        ...
        this.setState({ use_ssh_keys: isChecked });
      },
      ...
      render: function () {
        ...
        return (
              <div>
                ...
                <div>
                  <input type="checkbox" checked={use_ssh_keys} onChange={this.handleChangeSSHPreference}/>
                  &nbsp;&nbsp;Enable ssh access into launched instances.
                </div>
                <div>
