...
export default {
    ...
    add: function(params) {
        ...
        imageVersionScript.save(null, {
            ...
            Utils.dispatch(ImageVersionScriptConstants.ADD_IMAGEVERSION_SCRIPT, {
                image_versionScript: imageVersionScript
            });
        }).fail(function(response) {
            Utils.displayError({
                title: "Script could not be added to ImageVersion",
                response: response
            });
        });
    },
    ...
    remove: function(params) {
        ...
        imageVersionScript.destroy().done(function() {
            Utils.dispatch(ImageVersionScriptConstants.REMOVE_IMAGEVERSION_SCRIPT, {
                image_versionScript: imageVersionScript
            });
        }).fail(function(response) {
            Utils.displayError({
                title: "Script could not be removed from ImageVersion",
                response: response
            });
        });
    }
