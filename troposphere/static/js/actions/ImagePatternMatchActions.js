...
export default {
    add: function(params) {
        ...
        if (!params.pattern_match) throw new Error("Missing pattern_match");
        ...
        imagePatternMatch
            ...
            .done(function() {
                Utils.dispatch(
                    ImagePatternMatchConstants.ADD_IMAGE_PATTERN_MATCH,
                    {
    ...
    remove: function(params) {
        ...
        imagePatternMatch
            ...
            .done(function() {
                Utils.dispatch(
                    ImagePatternMatchConstants.REMOVE_IMAGE_PATTERN_MATCH,
                    {
                        imagePatternMatch: imagePatternMatch
                    }
                );
