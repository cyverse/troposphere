...
export default {
    ...
    create: function(params, onSuccess, onFailure) {
        ...
        project
            ...
            .fail(function() {
                var message =
                    "Error creating Project " + project.get("name") + ".";
    ...
    destroy: function(params) {
        ...
        project
            ...
            .fail(function() {
                var failureMessage =
                    "Error deleting Project " + project.get("name") + ".";
    ...
    removeResources: function(params) {
        ...
        resources.map(function(resource) {
            ...
            if (resource instanceof Instance) {
                Utils.dispatch(
                    NullProjectInstanceConstants.ADD_INSTANCE_TO_NULL_PROJECT,
                    {
                        instance: resource
                    }
                );
                ...
                Utils.dispatch(
                    NullProjectVolumeConstants.ADD_VOLUME_TO_NULL_PROJECT,
                    {
                        volume: resource
                    }
                );
