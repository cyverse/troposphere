...
export default {
    destroy: function(payload, options) {
        ...
        Utils.dispatch(ExternalLinkConstants.REMOVE_LINK, {
        ...
        external_link
            ...
            .done(function() {
                NotificationController.success(
                    null,
                    "ExternalLink " + external_link.get("title") + " deleted."
                );
            })
            .fail(function() {
                var failureMessage =
                    "Error deleting ExternalLink " +
                    external_link.get("title") +
                    ".";
                NotificationController.error(null, failureMessage);
                Utils.dispatch(ExternalLinkConstants.ADD_LINK, {
                    external_link: external_link
                });
            });
    },
