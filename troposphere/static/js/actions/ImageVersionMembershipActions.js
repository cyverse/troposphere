...
export default {
    ...
    add: function(params) {
        ...
        imageVersionMembership.save(null, {
            ...
            Utils.dispatch(ImageVersionMembershipConstants.ADD_IMAGEVERSION_MEMBERSHIP, {
                image_versionMembership: imageVersionMembership
            });
        }).fail(function(response) {
            Utils.displayError({
                title: "Membership could not be added to ImageVersion",
                response: response
            });
        });
    },
    ...
    remove: function(params) {
        ...
        imageVersionMembership.destroy().done(function() {
            Utils.dispatch(ImageVersionMembershipConstants.REMOVE_IMAGEVERSION_MEMBERSHIP, {
                image_versionMembership: imageVersionMembership
            });
        }).fail(function(response) {
            Utils.displayError({
                title: "Membership could not be removed from ImageVersion",
                response: response
            });
        });
    }
