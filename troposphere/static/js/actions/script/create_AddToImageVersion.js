...
export default {
    create_AddToImageVersion: function(image_version, params) {
        ...
        if (!params.strategy) throw new Error("Missing strategy");
        ...
        script
            ...
            .done(function() {
                ...
                Utils.dispatch(
                    ScriptConstants.REMOVE_PENDING_SCRIPT_FROM_VERSION,
                    {
                        script: script,
