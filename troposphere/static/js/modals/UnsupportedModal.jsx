        ...
        var content = (
            <div>
                <h4 className="t-body-2">
                    This application uses features your browser does not support
                </h4>
                <p>
                    For the best user experience please update your browser. We
                    recomend using a desktop or laptop with one of the following
                    browsers.
                </p>
                ...
                <hr />
                <h4 className="t-body-2">
                    Features that may cause problems with your browser
                </h4>
                <BreakingFeatureList />
            </div>
        );
